...
| 8 | Controlled acceptance and packaging | In progress | Windows Sandbox clean-install gate passed and Universal macOS DMG retained; real Apple Silicon beta remains |
...
- Universal macOS packaging run `29636642618` passed all frontend and Rust checks/tests, verified both arm64 and x86_64 Mach-O slices, and produced the retained DMG. DMG SHA-256: `986aeed5f99074f92599c3ee929936ae0ceba03f0d9db562b47f7f0986cf9eeb`.
...
| 2026-07-16 / 2026-07-18 | 8 | `df7e21aa` | `29499764899`; package `29500323839` | Apple Silicon `29499771820`; Universal package `29636642618` | Windows gate and package retention accepted; phase remains open | Guided Sandbox run `88ea30f0a8024106acbee0888928c5c6` passed Node/npm/Codex and fresh-shell PATH execution; MSI, Windows ZIP, and Universal macOS DMG hashes verified; real Apple Silicon beta remains required before stable release |
